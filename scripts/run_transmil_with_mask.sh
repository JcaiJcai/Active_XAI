#!/bin/bash
#SBATCH --job-name="transmil_m0"
#SBATCH --output="/u/jcai1/code/usefulxai/code/my_method/results/scripts/transmil_mask0"
...
python3 main.py --project=transmil_mask0_0414 \
