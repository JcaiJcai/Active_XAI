#!/bin/bash
#SBATCH --job-name=transmil_annotation_loss_10
#SBATCH --output=/u/jcai1/code/usefulxai/paper_results/pure/transmil_annotation_loss_10.out
