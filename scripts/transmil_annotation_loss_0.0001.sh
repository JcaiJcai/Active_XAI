#!/bin/bash
#SBATCH --job-name=transmil_annotation_loss_0.0001
#SBATCH --output=/u/jcai1/code/usefulxai/paper_results/pure/transmil_annotation_loss_0.0001.out
