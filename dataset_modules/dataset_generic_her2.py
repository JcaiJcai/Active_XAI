...
class Generic_MIL_Dataset_Her2(Generic_WSI_Classification_Dataset):
	def __init__(self,
		data_dir, 
		h5_folder_name,
		use_h5,
		**kwargs):
		...
		super(Generic_MIL_Dataset_Her2, self).__init__(**kwargs)
...
class Generic_Split(Generic_MIL_Dataset_Her2):
