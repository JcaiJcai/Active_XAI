#!/bin/bash
#SBATCH --job-name=transmil_uncertainty_top40_0.01_2023
#SBATCH --output=/u/jcai1/code/usefulxai/paper_results/pure/transmil_uncertainty_top40_0.01_2023.out
